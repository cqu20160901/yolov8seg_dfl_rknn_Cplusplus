...
int detect(char *model_path, char *image_path, char *save_image_path)
{
    ...
    GetResultRectYolov8seg PostProcess;
    std::vector<float> DetectiontRects;

    cv::Mat SegMask;
    SegMask = cv::Mat::zeros(160, 160, CV_8UC3);
    PostProcess.GetConvDetectionResult(pblob, out_zps, out_scales, DetectiontRects, SegMask);

    cv::Mat SegMaskResize;
    cv::resize(SegMask, SegMaskResize, cv::Size(640, 640), 0, 0, cv::INTER_LINEAR);
    ...
    cv::Mat SrcAddMask;
    cv::addWeighted(src_image, 0.55, SegMaskResize, 0.45, 0, SrcAddMask);

    cv::imwrite(save_image_path, SrcAddMask);
...
{
    char model_path[256] = "/home/firefly/zhangqian/rknn/rknpu2_1.4.0/examples/rknn_yolov8seg_80C_demo_dfl_open/model/RK3588/yolov8nseg_relu_80class_dfl.rknn";
    char image_path[256] = "/home/firefly/zhangqian/rknn/rknpu2_1.4.0/examples/rknn_yolov8seg_80C_demo_dfl_open/test.jpg";
    char save_image_path[256] = "/home/firefly/zhangqian/rknn/rknpu2_1.4.0/examples/rknn_yolov8seg_80C_demo_dfl_open/test_result.jpg";
